        ...
        <div class="modal-content p-0">
            ...
            <div class="modal-header mb-1">
                <h5 class="modal-title">
                    <span class="align-middle">{{ __('locale.Edit User Role') }}</span>
                </h5>
            </div>
            <div class="modal-body flex-grow-1">
                <form id="editForm" class="mt-2" method="POST">
                    ...
                    <div class="mb-1" id="edit-permissions-box">
                        <label class="form-label" for="select2-multiple">{{ __('locale.Role Permissions') }}</label>
                        <select class="select2 form-select" id="edit-permissions" multiple>
                        </select>
                    </div>
