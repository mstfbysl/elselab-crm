...
@section('title', __('locale.Invoices'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title">{{ __('locale.Invoices') }}</h4>
                    <button 
...
$(function() {
    ...
    var DataTable = $('#DataTable').DataTable({
        ...
        ajax: '/api/invoice/list-datatable',
        order: [[0, 'desc']],
        language: {
            paginate: {
                previous: '&nbsp;',
    ...
    window.onCreate = () => {
        location.href = '/invoice/create'
    }

    window.onEdit = (ID) => {

        location.href = 'purchase-invoice/edit/' + ID;
    ...
    DataTable.on('click', '.ispaid', function (e) {
        ...
        AxiosPOST('/api/invoice/set-is-paid/' + ID, {is_paid: is_paid}, (r) => {
    ...
    DataTable.on('click', '.isaccountant', function (e) {
        ...
        AxiosPOST('/api/invoice/set-is-accountant/' + ID, {is_accountant: is_accountant}, (r) => {
