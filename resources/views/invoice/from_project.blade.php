...
@section('content')
<input type="hidden" id="project-id" value="{{ request()->id }}">
        ...
        <div class="col-xl-9 col-md-8 col-12">
            <div class="card invoice-preview-card">
                ...
                <div class="card-body invoice-padding invoice-product-details">
                    <form class="create-invoice-item-list">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-2">
                                ...
                                <textarea class="form-control" rows="2" placeholder="Invoice Note" id="create-invoice-note"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
$(async function() {
    ...
    $('#create-invoice-serie').on('select2:select', function (e) {
        let serie = $(this).val();
        update_serie(serie, $('#create-invoice-date').val());
    });
    ...
    AxiosGET('/api/invoice/details-from-project/' + id, (r)  => {
