...
@section('title', __('locale.Status'))
...
$(function() {
    ...
    var DataTable = $('#DataTable').DataTable({
        ...
        ajax: '/api/status/list-datatable',
        language: {
            paginate: {
                previous: '&nbsp;',
                next: '&nbsp;'
    ...
    createForm.submit(() => {
        ...
        AxiosPOST('/api/status/create', {title, color}, (r) => {
    ...
    editForm.submit(() => {
        ...
        AxiosPOST('/api/status/edit/' + id, {title, color}, (r) => {
    ...
    window.onEdit = (ID) => {
        ...
        AxiosGET('/api/status/detail/' + ID, (r) => {
    ...
    window.onDelete = (ID) => {
        AxiosAskGET('/api/status/delete/' + ID, (r) => {
