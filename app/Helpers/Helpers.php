...
class Helpers
{
    public static function applClasses()
    {
        ...
        if($user){
            $data['theme'] = $user->theme_color;
            $data['layoutWidth'] = $user->theme_layout;
            $data['horizontalMenuType'] = $user->theme_nav_style;
            $data['verticalMenuNavbarType'] = $user->theme_nav_style;
        }
        ...
        $layoutClasses['appName'] = $setting->app_name;
        $layoutClasses['appLogo'] = $setting->logo_preview;
        $layoutClasses['appFavicon'] = $setting->favicon_preview;
    ...
    public static function human_format($val)
    {
        $setting = SystemSetting::first();

        return $setting->currency->symbol . ' ' . number_format($val, 2, '.', ' ');
    }
}
